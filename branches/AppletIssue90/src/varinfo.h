...
#ifndef SRC_VARINFO_H_
#define SRC_VARINFO_H_
...
char* web100vartable[][2] = {
  ...
  { "AckPktsOut",
    "The number of pure ack packets that have been sent\n"
  ...
  {
    "DataBytesOut",
    "The number of octets of data contained in transmitted segments,\n"
        "including retransmitted data.  Note that this does not include\n"
        "TCP headers.\n"
  },
  {
    "DataPktsIn",
    "The number of segments received containing a positive length\n"
        "data segment.\n"
  },
  {
    "DataPktsOut",
    "The number of segments sent containing a positive length data\n"
        "segment.\n"
  },
  { "DupAcksIn", "The number of duplicate ACKs received.\n" },
  {
    "ECNEnabled",
    "Enabled(1) if Explicit Congestion Notification (ECN)\n"
  ...
  {
    "MinRwinSent",
    "The minimum window advertisement sent, excluding the initial\n"
  ...
  {
    "RcvWinScale",
    "The value of Rcv.Wind.Scale.  Note that\n"
  ...
  {
    "SndWinScale",
    "The value of Snd.Wind.Scale.  Note that\n"
  ...
  {
    "Duration",
    "The seconds part of the time elapsed between StartTimeStamp\n"
        "and the most recent protocol event (segment sent or received).\n"
  },
  { NULL, NULL }
};

#endif  // SRC_VARINFO_H_
